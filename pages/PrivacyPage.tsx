...
import { COMPANY, companyLegalBlurb } from '../data/company'
          ...
          <SectionCard variant="contact" className="relative overflow-hidden">
            ...
            <LegalProse>
              ...
              <ul>
                ...
                <li>
                  <p>
                    <strong>Website</strong> refers to {COMPANY.websiteHost}, accessible from{' '}
                    <a
              ...
              <p>
                ...
                advertising, and remarketing cookies) only with Your consent. You can withdraw
                or change Your consent at any time using Our cookie preferences tool (if
                available) or through Your browser/device settings. Withdrawing consent does not
              ...
              <ul>
                ...
                <li>
                  ...
                  share Personal Data or otherwise interact in the public areas with other users,
              ...
              <ul>
                ...
                <li>
                  ...
                  <ul>
                    <li>
                      <p>
                        Website analytics data (cookies, IP addresses, device identifiers): up to
                        24 months from the date of collection, which allows us to analyze trends while
              ...
              <ul>
                <li>
                  ...
                  <p>
                    Mouseflow is a session replay and heatmap tool that shows how visitors click, move,
                    scroll, browse, and pay attention on websites. The service is operated by ApS.
                  </p>
